...
class AggregateStepCountRecheckTests(unittest.TestCase):
    def test_only_consensus_rechecked_values_become_overrides(self):
        audit_rows = [
            {"question_id": "q1", "original_step_count": "3-5步"},
            {"question_id": "q2", "original_step_count": "1-2步"},
        ]
        votes = [
            *[{"question_id": "q1", "valid": True, "parsed_step_count": value} for value in ("6步以上", "6步以上", "3-5步")],
            *[{"question_id": "q2", "valid": True, "parsed_step_count": value} for value in ("6步以上", "3-5步", "1-2步")],
        ]
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertEqual(rows[0]["rechecked_step_count"], "6步以上")
            ...
            self.assertEqual(override_rows, [{"question_id": "q1", "step_count": "6步以上"}])
